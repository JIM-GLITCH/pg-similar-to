import type {
  ...
  Set,
  Term,
} from "@chevrotain/regexp-to-ast/types";
import {
  addFlag,
  ASSERT_EXISTS,
  ...
  insertToSet,
  isCharacter,
} from "@chevrotain/regexp-to-ast/src/utils.js";
import {
  digitsCharCodes,
  whitespaceCodes,
  wordCharCodes,
} from "@chevrotain/regexp-to-ast/src/character-classes.js";
...
export class SimilarToPatternParser implements RegExpParser {
  ...
  percentAll(): Omit<Set, "loc"> | undefined {
    const begin = this.idx
    this.consumeChar("%");
    return {
      type: "Set",
  ...
  protected underscoreAll(): Omit<Set, "loc"> {
    this.consumeChar("_");
    return {
      type: "Set",
      complement: true,
